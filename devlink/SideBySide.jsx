...
import _styles from "./SideBySide.module.css";
...
export function SideBySide({ as: _Component = _Builtin.Section }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Heading
                ...
                data-w-id="f79a5177-e397-d7b9-cec3-705daec90b9d"
                tag="h1"
              >
                {"Heading Text"}
              </_Builtin.Heading>
              <_Builtin.Heading
                ...
                data-w-id="f79a5177-e397-d7b9-cec3-705daec90b9f"
                tag="h2"
              >
                {
              ...
              <_Builtin.Link
                ...
                data-w-id="f79a5177-e397-d7b9-cec3-705daec90ba6"
                button={false}
                block="inline"
                options={{
          ...
          <_Builtin.HFlex
            className={_utils.cx(_styles, "flex-block-3")}
            tag="div"
          >
            <_Builtin.Image
              className={_utils.cx(_styles, "banner-carousel-img-3")}
              width="auto"
              height="auto"
              loading="lazy"
              alt=""
