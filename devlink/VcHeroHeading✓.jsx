...
import _styles from "./VcHeroHeading✓.module.css";
...
export function VcHeroHeadingcheck_mark({
  ...
  variant = "Default",
  headingOptionsHeadingLevel = "h1",
  headingOptionsSubHeadingLevel = "h3",
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  const _styleVariantMap = {
    Default: "",
    "Default (White)": "w-variant-17c744b7-3962-73cc-b398-11d33ff6619a",
    "Default (Gray)": "w-variant-0582d3ef-c4bb-6ebe-24b0-7d79113529de",
    "Default (Pewter)": "w-variant-60d9df4a-0288-eb97-71c3-7b285bed61d5",
    "Weddings (White)": "w-variant-a421c027-6b2b-d243-8add-69bd93787265",
  };
  ...
  return (
    ...
    >
      <_Builtin.Heading
        className={_utils.cx(_styles, "hero-heading", _activeStyleVariant)}
        tag={headingOptionsHeadingLevel}
      >
      ...
      {headingOptionsEnableSubHeading ? (
        <_Builtin.Heading
          ...
          tag={headingOptionsSubHeadingLevel}
        >
