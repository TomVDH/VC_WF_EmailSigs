...
export function VcFootercheck_markcheck_mark({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "oz-footer")}
      grid={{
        type: "section",
      }}
      tag="footer"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "vc_footer__main")}
        tag="div"
      >
        <_Builtin.Section
          className={_utils.cx(_styles, "vc_footer__stack", "footer-colofon")}
          grid={{
            type: "section",
          }}
          tag="div"
        >
          <_Builtin.BlockContainer
            className={_utils.cx(_styles, "vc-footer__colofon")}
            grid={{
              type: "container",
            }}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "colofon-left", "is--colofon-gap")}
              id={_utils.cx(
                _styles,
                "w-node-_50223fda-82f2-3af6-9d41-1438dcb9659f-a8090518"
              )}
              tag="div"
            >
              <_Builtin.Block
              ...
              >
                <_Builtin.Link
                  ...
                  block=""
                  options={{
                    href: "https://members.vanclub.com/login",
                    target: "_blank",
                    preload: "none",
                  }}
                >
                  {"Member Platform"}
                  <_Builtin.DOM
                    className={_utils.cx(_styles, "svg-6")}
                    tag="svg"
                    width="100%"
                    height="100%"
                    viewBox="0 0 16 16"
              ...
              >
                <_Builtin.Link
                  ...
                  data-w-id="4062d101-143c-8986-3ef6-db731efcc520"
                  button={false}
                  block=""
                  options={{
                    href: "#",
            ...
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-_272b03a5-c2bf-a04a-f132-cdb3ece0b6cb-a8090518"
              )}
              tag="div"
            >
              <_Builtin.Link
              ...
              >
                <_Builtin.Image
                  className={_utils.cx(_styles, "vc_footer__logo")}
                  editable={false}
                  loading="eager"
                  width="180"
                  height="auto"
              ...
              >
                <_Builtin.Strong>
                  <_Builtin.Emphasized
                    className={_utils.cx(_styles, "italic-text")}
                  >
                    {"604.685.9321"}
                  </_Builtin.Emphasized>
                </_Builtin.Strong>
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "c-nav_sociall-white")}
                tag="div"
              >
                <_Builtin.Link
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "colofon-right", "is--colofon-gap")}
              id={_utils.cx(
                _styles,
                "w-node-c4f33025-a1c7-4466-5937-38f32705c5b9-a8090518"
              )}
              tag="div"
            >
              <_Builtin.Link
              ...
              <_Builtin.Link
                ...
                data-w-id="a1a1be2d-285d-8202-79ea-7d6f8f954cc6"
                button={false}
                block=""
                options={{
                  href: "#",
        ...
        <_Builtin.Section
          className={_utils.cx(_styles, "vc_footer__stack", "footer-links")}
          grid={{
            type: "section",
          }}
          tag="div"
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "links-container")}
              tag="div"
            >
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                id={_utils.cx(
                  _styles,
                  "w-node-_306a88ad-a489-4cc6-a97c-d1e9cfa9cb1a-a8090518"
                )}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/67255433db55227c08e2b022_members_on_sunroof_anamor.jpg"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/661469aeb216299b39352a59_Venues%20and%20Menus%20page%20banner.png"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/6557bb5d53809623bd8abfed_Ballroom-Draping202006198-p-2000.jpg"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/65b4303f8a3e1316a9ce1b76_Wedding%20Campaign%202024%20Let%20Love%20Lights.jpg"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/6557bb5d53809623bd8ac01e_Prayer-Hands-Edit-1.jpg"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/6557bb5d53809623bd8ac026_st-james-paris-fill.jpg"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/6557bb5d53809623bd8abfcc_Copy-of-Bedroom-0269.jpg"
                block=""
                options={{
                  href: "#",
                }}
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "c-menu-link")}
                button={false}
                data-bg="https://cdn.prod.website-files.com/6557bb5d53809623bd8abf36/6557bb5d53809623bd8ac06f_Ed-Spence-773x1024.jpg"
                block=""
                options={{
                  href: "#",
                }}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "colofon-bottom")}
          id={_utils.cx(
            _styles,
            "w-node-feea454c-3748-c5c7-4511-064e85ccc20c-a8090518"
          )}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "vc_footer_la")}
            tag="div"
          >
            {
      ...
      <_Builtin.BlockContainer
        className={_utils.cx(_styles, "vc_footer__modal")}
        grid={{
          type: "container",
        }}
        tag="div"
          ...
          >
            <_Builtin.NavbarBrand
              className={_utils.cx(
                _styles,
                "header-burger",
                "vc_modal--sticky-right",
                "vc_modal--close"
              )}
              data-w-id="98f9ee73-65e4-f112-0a13-40211a9607ab"
              options={{
                href: "#",
              }}
            />
            ...
            >
              <_Builtin.Image
                className={_utils.cx(_styles, "vc-fleuron-buildig")}
                loading="eager"
                width="60"
                height="auto"
                alt=""
              ...
              <_Builtin.Block
                ...
                tag="div"
              >
                {"Our Member Services look forward to receive you."}
              </_Builtin.Block>
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-9")}
                id={_utils.cx(
                  _styles,
                  "w-node-_98aff21a-ef5c-832c-b6c0-dde60e9a499f-a8090518"
                )}
                tag="div"
              >
                <_Builtin.Link
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-cced5ef5-3c98-03c9-5d7b-cab6c5d9fc52-a8090518"
                  )}
                  button={true}
                  block=""
                  options={{
                    href: "mailto:concierge@vancouverclub.ca?subject=(Site)%20For%20the%20Concierge%20(insert%20subject%20line%20here)",
                  }}
                >
                  {"Email US"}
                  <br />
                ...
                <_Builtin.Link
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-_12085ea9-8f58-d094-8578-69a287d12f59-a8090518"
                  )}
                  button={true}
                  block=""
                  options={{
                    href: "tel:+16046859321",
                  }}
                >
                  {"Call US"}
                  <br />
              ...
              <_Builtin.HtmlEmbed
                ...
                value="%3Cdiv%20style%3D%22width%3A%20400px%3B%20text-align%3A%20center%3B%22%3E%0A%20%20%3Chr%20style%3D%22border%3A%20none%3B%20border-top%3A%201px%20solid%20%23000%3B%20width%3A%2040%25%3B%20margin%3A%2010px%20auto%3B%20opacity%3A%200.7%3B%22%3E%0A%3C%2Fdiv%3E"
              />
            </_Builtin.Block>
          </_Builtin.Section>
        </_Builtin.Block>
      ...
      <_Builtin.BlockContainer
        className={_utils.cx(_styles, "colofon")}
        grid={{
          type: "container",
        }}
        tag="div"
      >
        <_Builtin.Paragraph
          className={_utils.cx(_styles, "vc_notfordesktop", "vc_footer_la")}
        >
          {"© 2025 The Vancouver Club, All Rights Reserved"}
        </_Builtin.Paragraph>
      </_Builtin.BlockContainer>
    </_Component>
  );
